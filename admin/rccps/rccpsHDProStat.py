...
if __name__ == '__main__':
    ...
    try:
        AfaLoggerFunc.tradeInfo("***农信银系统: 系统调度类.汇兑业务量统计[rccpsHDProStat]进入***")
        ...
        #==================汇兑往账统计=========================================
        AfaLoggerFunc.tradeInfo(">>>开始汇兑往账业务量统计")
        ...
        tmp_sql = tmp_sql + " from rcc_hddzmx a left join rcc_subbra b on a.sndbnkco = b.bankbin"
        ...
        if ret < 0:
            AfaLoggerFunc.tradeInfo(AfaDBFunc.sqlErrMsg)
            rccpsCronFunc.cronExit("S999","汇兑往账业务量统计异常")
        
        AfaLoggerFunc.tradeInfo(">>>结束汇兑往账业务量统计")
        
        #==================汇兑来账统计=========================================
        AfaLoggerFunc.tradeInfo(">>>开始汇兑来账业务量统计")
        ...
        tmp_sql = tmp_sql + " from rcc_hddzmx a left join rcc_subbra b on a.rcvbnkco = b.bankbin"
        ...
        if ret < 0:
            AfaLoggerFunc.tradeInfo(AfaDBFunc.sqlErrMsg)
            rccpsCronFunc.cronExit("S999","汇兑来账业务量统计异常")
        
        AfaLoggerFunc.tradeInfo(">>>结束汇兑来账业务量统计")
        
        #================关闭汇兑业务量统计系统调度===========
        AfaLoggerFunc.tradeInfo(">>>开始关闭汇兑业务量统计系统调度")
        if not rccpsCronFunc.closeCron("00036"):
            AfaLoggerFunc.tradeInfo( AfaDBFunc.sqlErrMsg )
            rccpsCronFunc.cronExit("S999","关闭汇兑业务量统计调度异常")
        ...
        AfaLoggerFunc.tradeInfo(">>>结束关闭汇兑业务量统计系统调度")
        
        AfaLoggerFunc.tradeInfo("***农信银系统: 系统调度类.汇兑业务量统计[rccpsHDProStat]退出***")
        ...
        if TradeContext.errorCode != '0000' :
            ...
            AfaLoggerFunc.tradeInfo('***[rccpsHDProStat]交易中断***')
