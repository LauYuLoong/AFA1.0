# -*- coding: gbk -*-
################################################################################
#   农信银系统：系统调度类.汇票对账明细账勾兑
#===============================================================================
#   交易文件:   rccpsHPDZMXCompare.py
#   公司名称：  北京赞同科技有限公司
#   作    者：  关彬捷
#   修改时间:   2008-06-27
################################################################################
...
if __name__ == '__main__':
    ...
    try:
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'02','往账行内无,中心有','" + PL_ISDEAL_UNDO + "','','','','' "
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'03','往账行内已记账,中心未清算','" + PL_ISDEAL_UNDO + "','','','','' "
        temp_sql = temp_sql + "from rcc_bilbka as a,rcc_spbsta as b "
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'04','往账行内未清算,中心清算','" + PL_ISDEAL_UNDO + "','','','','' "
        temp_sql = temp_sql + "from rcc_bilbka as a,rcc_spbsta as b "
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'05','来账行内有,中心无','" + PL_ISDEAL_UNDO + "','','','','' "
        temp_sql = temp_sql + "from rcc_bilbka as a,rcc_spbsta as b "
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'06','来账行内无,中心有','" + PL_ISDEAL_UNDO + "','','','','' "
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'07','来账行内清算,中心未清算','" + PL_ISDEAL_UNDO + "','','','','' "
        temp_sql = temp_sql + "from rcc_bilbka as a,rcc_spbsta as b "
        ...
        temp_sql = ""
        temp_sql = temp_sql + "insert into rcc_hpdzcz(select a.sndbnkco,a.trcdat,a.trcno,a.nccwkdat,a.trcco,a.bjedte,a.bspsqn,'08','来账行内未清算,中心清算','" + PL_ISDEAL_UNDO + "','','','','' "
        temp_sql = temp_sql + "from rcc_bilbka as a,rcc_spbsta as b "
        ...
        if TradeContext.errorCode != '0000' :
            ...
            AfaLoggerFunc.tradeInfo('***[rccpsHPDZMXCompare]交易中断***')
