# -*- coding: gbk -*-
##################################################################
#   农信银系统 rcc_ztcbka 数据库表操作函数
#
#   作    者：  关彬捷
#   程序文件:   rccpsDBTrcc_ztcbka.py
#   修改时间:   Tue Dec 16 19:39:24 2008
##################################################################
import AfaDBFunc,AfaLoggerFunc
from types import *

table_tuple = ('BJEDTE', 'BSPSQN', 'BRSFLG', 'BESBNO', 'BEACSB', 'BETELR', 'BEAUUS', 'NCCWKDAT', 'TRCCO', 'TRCDAT', 'TRCNO', 'SNDMBRCO', 'RCVMBRCO', 'SNDBNKCO', 'SNDBNKNM', 'RCVBNKCO', 'RCVBNKNM', 'BOJEDT', 'BOSPSQ', 'ORTRCCO', 'CUR', 'OCCAMT', 'CONT', 'NCCTRCST', 'MBRTRCST', 'ISDEAL', 'PRCCO', 'STRINFO', 'NOTE1', 'NOTE2', 'NOTE3', 'NOTE4')
table_dict = {'BEAUUS': 'S', 'CONT': 'S', 'TRCDAT': 'S', 'ORTRCCO': 'S', 'TRCCO': 'S', 'PRCCO': 'S', 'SNDMBRCO': 'S', 'MBRTRCST': 'S', 'RCVMBRCO': 'S', 'OCCAMT': 'F', 'NCCTRCST': 'S', 'CUR': 'S', 'BJEDTE': 'S', 'BSPSQN': 'S', 'RCVBNKCO': 'S', 'BOSPSQ': 'S', 'SNDBNKNM': 'S', 'BEACSB': 'S', 'RCVBNKNM': 'S', 'NCCWKDAT': 'S', 'BRSFLG': 'S', 'STRINFO': 'S', 'ISDEAL': 'S', 'BOJEDT': 'S', 'NOTE1': 'S', 'NOTE3': 'S', 'NOTE2': 'S', 'NOTE4': 'S', 'SNDBNKCO': 'S', 'TRCNO': 'S', 'BESBNO': 'S', 'BETELR': 'S'}
...
def count( wheresql ):
    ...
    sql = "SELECT count(*) FROM rcc_ztcbka WHERE " + wheresql
...
def update( update_dict,where_dict ):
    ...
    sql = "UPDATE rcc_ztcbka SET " + updatesql[0:-1] + " WHERE " + wheresql[0:-5]
    AfaLoggerFunc.tradeInfo(sql)
