# -*- coding: gbk -*-
##################################################################
#   农信银系统 TradeContext 字典到 mpcbka_dict 字典映射函数
#
#   作    者：  关彬捷
#   程序文件:   rccpsMap1145CTradeContext2Dmpcbka_dict.py
#   修改时间:   Sat Dec  6 13:29:03 2008
##################################################################
...
def map(to_dict):
    ...
    if TradeContext.existVariable('OPRATTNO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[OPRATTNO] = ' + str(to_dict['OPRATTNO']))
    else:
    ...
    if TradeContext.existVariable('MSGFLGNO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[MSGFLGNO] = ' + str(to_dict['MSGFLGNO']))
    else:
    ...
    if TradeContext.existVariable('ORTRCCO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[ORTRCCO] = ' + str(to_dict['ORTRCCO']))
    else:
    ...
    if TradeContext.existVariable('ORTRCDAT'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[ORTRCDAT] = ' + str(to_dict['ORTRCDAT']))
    else:
    ...
    if TradeContext.existVariable('ORTRCNO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[ORTRCNO] = ' + str(to_dict['ORTRCNO']))
    else:
        AfaLoggerFunc.tradeDebug("TradeContext.ORTRCNO不存在")

    if TradeContext.existVariable('ORMFN'):
        to_dict['ORMFN'] = TradeContext.ORMFN
        AfaLoggerFunc.tradeDebug('mpcbka_dict[ORMFN] = ' + str(to_dict['ORMFN']))
    else:
    ...
    if TradeContext.existVariable('SNDMBRCO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[SNDMBRCO] = ' + str(to_dict['SNDMBRCO']))
    else:
    ...
    if TradeContext.existVariable('RCVMBRCO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[RCVMBRCO] = ' + str(to_dict['RCVMBRCO']))
    else:
    ...
    if TradeContext.existVariable('SNDBNKCO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[SNDBNKCO] = ' + str(to_dict['SNDBNKCO']))
    else:
    ...
    if TradeContext.existVariable('SNDBNKNM'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[SNDBNKNM] = ' + str(to_dict['SNDBNKNM']))
    else:
    ...
    if TradeContext.existVariable('RCVBNKCO'):
        ...
        AfaLoggerFunc.tradeDebug('mpcbka_dict[RCVBNKCO] = ' + str(to_dict['RCVBNKCO']))
    else:
