# -*- coding: gbk -*-
###############################################################################
#   农信银系统：来账.中心类操作(1.本地操作 2.中心回执).卡本转异应答报文接收
#==============================================================================
#   交易文件:   TRCC006_1154.py
#   公司名称：  北京赞同科技有限公司
#   作    者：  关彬捷 
#   修改时间:   2008-10-21
###############################################################################
...
#=====================交易前处理(登记流水,中心前处理)==========================
def SubModuleDoFst():
    AfaLoggerFunc.tradeInfo(" 农信银系统：来账.中心类操作(1.本地操作).卡本转异应答报文接收[TRCC006_1154]进入 ")
    ...
    if not rccpsDBFunc.getTransWtrAK(TradeContext.SNDBNKCO,TradeContext.TRCDAT,TradeContext.TRCNO,wtr_dict):
        return AfaFlowControl.ExitThisFlow('S999', "未找到原本转异请求交易,停止处理")
    ...
    AfaLoggerFunc.tradeInfo(" 农信银系统：来账.中心类操作(1.本地操作).卡本转异应答报文接收[TRCC006_1154]退出 ")
    return True


#=====================交易后处理===============================================
def SubModuleDoSnd():
    AfaLoggerFunc.tradeInfo(" 农信银系统：来账.中心类操作(2.中心回执).卡本转异应答报文接收[TRCC006_1154]进入 ")
    ...
    AfaLoggerFunc.tradeInfo(" 农信银系统：来账.中心类操作(2.中心回执).卡本转异应答报文接收[TRCC006_1154]退出 ")
