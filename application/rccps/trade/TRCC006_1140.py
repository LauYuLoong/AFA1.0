# -*- coding: gbk -*-
###############################################################################
#   农信银系统：来账.中心类操作(1.本地操作 2.中心回执).折通兑来帐
#==============================================================================
#   交易文件:   TRCC006_1140.py
#   公司名称：  北京赞同科技有限公司
#   作    者：  liyj 
#   修改时间:   2008-11-05
###############################################################################
import TradeContext,AfaLoggerFunc,AfaUtilTools,AfaDBFunc,TradeFunc,AfaFlowControl,os,AfaAfeFunc,AfaFunc,jiami,time
from types import *
...
import rccpsMap1140CTradeContext2Dwtrbka_dict,rccpsDBTrcc_atcbka
...
#=====================交易后处理===============================================
def SubModuleDoSnd():
    AfaLoggerFunc.tradeInfo( '***农信银系统：来账.中心类操作(2.中心回执).折通兑来帐请求报文接收[TRCC006_1140]进入***' )
    ...
    AfaLoggerFunc.tradeInfo( '***农信银系统：来账.中心类操作(2.中心回执).折通兑来帐请求报文接收[TRCC006_1140]退出***' )
    return True
