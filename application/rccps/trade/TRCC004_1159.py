# -*- coding: gbk -*-
###############################################################################
#   农信银系统：往账.回执类操作模板(1.回执操作).异转本应答
#==============================================================================
#   交易文件:   TRCC004_1159.py
#   公司名称：  北京赞同科技有限公司
#   作    者：  刘雨龙
#   修改时间:   2008-11-04
###############################################################################
...
import rccpsDBFunc,rccpsState,rccpsHostFunc,rccpsDBTrcc_atcbka

#=====================回执个性化处理(本地操作)=================================
def SubModuleDoFst():
    AfaLoggerFunc.tradeInfo( '***农信银系统：往账.本地类操作(1.本地操作).异转本_折应答[TRCC004_1159]进入***' )
    ...
    if wtr_dict['CHRGTYP'] == '1':
        ...
        TradeContext.CTFG    = '9'                                            #区分手续费和本金9为总金额
        ...
        TradeContext.I2CTFG  = '7'                                            #区分手续费和本金7为 本金
        TradeContext.I2PKFG  = 'T'                                            #通存通兑标示
        ...
        TradeContext.I3CTFG  = '8'                                            #区分手续费和本金8为手续费
        ...
        TradeContext.CTFG  = '7'                                              #区分手续费和本金7本金
        TradeContext.PKFG  = 'T'                                              #通存通兑标示
        TradeContext.WARNTNO = ''
        TradeContext.CERTTYPE = ''
        TradeContext.CERTNO = ''
        ...
        TradeContext.I2CTFG  =  '8'                                           #区分手续费和本金8为手续费
        TradeContext.I2PKFG  =  'T'                                           #通存通兑标示
        ...
        TradeContext.OTNM    =  TradeContext.PYENAM                           #贷方户名
        TradeContext.OCCAMT  =  str(wtr_dict['OCCAMT'])                       #金额
        TradeContext.CTFG    =  '7'                                           #区分手续费和本金7为本金
        TradeContext.PKFG    =  'T'                                           #通存通兑标示
        TradeContext.WARNTNO = ''
        TradeContext.CERTTYPE = ''
        TradeContext.CERTNO = ''
    ...
    AfaLoggerFunc.tradeInfo( '***农信银系统：往账.本地类操作(1.本地操作).异转本_折应答[TRCC004_1159]退出***' )
