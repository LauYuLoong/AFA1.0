            ...
            for i in range(ibegin,len(sAll.split(chr(12)))):
                ...
                if len(rec)>0:
                    if file=='AA11':
                        ...
                        sqlstr=''
                        sqlstr = "select count(*) from FS_FA13 where AFA031='" + rec.split(chr(31))[3] + "' and AAZ006='" + rec.split(chr(31))[1] + "' and BUSINO='" + TradeContext.busiNo + "'"
                        #sqlstr = "select count(*) from FS_FA13 where AFA031='" + rec.split(chr(31))[3] +  "' and BUSINO='" + TradeContext.busiNo + "'"
                        sqlstr = sqlstr + " and bankno ='" + TradeContext.bankbm + "'"
                        ...
                        if records[0][0]>=1:
                            ...
                            #如果记录存在,必须先删除,再新增
                            strStr_del = "DELETE FROM FS_FA13 where AFA031='" + rec.split(chr(31))[3] + "' and AAZ006='" + rec.split(chr(31))[1] + "' and BUSINO='" + TradeContext.busiNo + "'"
                            #strStr_del = "DELETE FROM FS_FA13 where AFA031='" + rec.split(chr(31))[3] + "' and BUSINO='" + TradeContext.busiNo + "'"
                            strStr_del = strStr_del + " and bankno ='" + TradeContext.bankbm + "'"
