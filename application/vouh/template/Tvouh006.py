...
def main( ):
    AfaLoggerFunc.tradeInfo( '凭证领用['+TradeContext.TemplateCode+']进入' )
    ...
    try:
        ...
        TradeContext.sVouhStatus  = '3' #状态       2.已发未领3.已领未用
        TradeContext.sExStatus    = '2' #原状态     2.已发未领时，可进行凭证领用，领用后状态为3.已领未用  
        TradeContext.sTransType    = '凭证领用'
        ...
        #=============程序退出====================
        AfaLoggerFunc.tradeInfo( '凭证领用['+TradeContext.TemplateCode+']退出' )
