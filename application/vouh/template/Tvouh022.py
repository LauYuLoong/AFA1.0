...
def main( ):
    AfaLoggerFunc.tradeInfo( '凭证注销['+TradeContext.TemplateCode+']进入' )
    ...
    try:
        ...
        TradeContext.sVouhNum  = [str(int(TradeContext.sEndNo[0]) - int(TradeContext.sStartNo[0]) + 1)]
        ...
        TradeContext.sVouhStatus  = '4' #状态       3.已领未用 4.已使用
        TradeContext.sExStatus    = '3' #原状态
        TradeContext.sRivTeller   = '   '     #对方柜员
        TradeContext.sTransType    = '凭证注销'
        ...
        #=============程序退出====================
        AfaLoggerFunc.tradeInfo( '凭证注销['+TradeContext.TemplateCode+']退出' )
