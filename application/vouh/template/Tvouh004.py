...
def main( ):
    AfaLoggerFunc.tradeInfo( '凭证出库['+TradeContext.TemplateCode+']进入' )
    ...
    try:
        ...
        #=============置凭证操作状态及库箱标志====================
        TradeContext.sDepository  = ' ' #库箱标志   1.分行管理库 2.支行管理库 3.网点管理库 4.柜员凭证箱
        TradeContext.sExDepos     = '1' #原库箱标志
        TradeContext.sVouhStatus  = '1' #状态       0.已入未发 1.已出库
        TradeContext.sExStatus    = '0' #原状态
        TradeContext.sRivTeller   = '   '     #对方柜员
        TradeContext.sTransType    = '凭证出库'
        ...
        #=============程序退出====================
        AfaLoggerFunc.tradeInfo( '凭证出库['+TradeContext.TemplateCode+']退出' )
