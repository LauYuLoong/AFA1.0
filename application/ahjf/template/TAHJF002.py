# -*- coding: gbk -*-
################################################################################
#   安徽交罚.缴费模板.先上主机.再去第三方
#===============================================================================
#   模板文件:   TAHJF002.py
#   修改时间:   2011-01-20
################################################################################
import TradeContext,AfaLoggerFunc,AfaUtilTools,AfaFunc,AfaAfeFunc,AfaFlowControl,TransBillFunc,AfaTransDtlFunc,Party3Context,AfaHostFunc,AhjfAdminFunc
from types import *

def main( ):
    AfaLoggerFunc.tradeInfo('******安徽交罚缴费模板['+TradeContext.TemplateCode+']进入******')
    try:
        #=====================初始化返回报文变量================================
        ...
        TradeContext.__agentAccno__ = TradeContext.ACCNO
        TradeContext.__autoRevTranCtl__ = "1"      #允许自动冲账  (20110317修改)
        ...
        #=====================退出模板==========================================
        AfaLoggerFunc.tradeInfo('******安徽交罚缴费模板['+TradeContext.TemplateCode+']退出******')
        ...
        AfaLoggerFunc.tradeInfo(TradeContext.__status__)
