...
def MainProc( ):
    ...
    try:
        ...
        sql = "SELECT * FROM ABDT_BATCHINFO WHERE STATUS IN ('21','22','30','31','32')"
        ...
        while ( i  < len(records) ):
            ...
            TradeContext.NOTE1       = str(records[i][23]).strip()         #备注1(提交状态)
            ...
            AbdtManager.WrtLog('批量作业:APPNO=[' + TradeContext.APPNO + '],BATCHNO=[' + TradeContext.BATCHNO + ']')
            ...
            elif ( TradeContext.STATUS == "10" ):
                AbdtManager.WrtLog('待校验:[' + TradeContext.BATCHNO + ']')
            ...
            elif ( TradeContext.STATUS == "11" ):
                AbdtManager.WrtLog('待分行审批:[' + TradeContext.BATCHNO + ']')


            elif ( TradeContext.STATUS == "20" ):
                AbdtManager.WrtLog('待总行审批:[' + TradeContext.BATCHNO + ']')


            elif ( TradeContext.STATUS == "21" ):
                AbdtManager.WrtLog('正在提交:[' + TradeContext.BATCHNO + ']')
                    
                AbdtManager.TJ_Proc(TradeContext.BATCHNO)


            elif ( TradeContext.STATUS == "22" ):
                AbdtManager.WrtLog('已提交:[' + TradeContext.BATCHNO + ']')

                AbdtManager.SC_Proc(TradeContext.BATCHNO)


            elif ( TradeContext.STATUS == "30" ):
                AbdtManager.WrtLog('待提回:[' + TradeContext.BATCHNO + ']')
                    
                AbdtManager.CX_Proc(TradeContext.BATCHNO)
                

            elif ( TradeContext.STATUS == "31" ):
                AbdtManager.WrtLog('正在提回:[' + TradeContext.BATCHNO + ']')

                AbdtManager.TH_Proc(TradeContext.BATCHNO)


            elif ( TradeContext.STATUS == "32" ):
                AbdtManager.WrtLog('已提回:[' + TradeContext.BATCHNO + ']')
                    
                AbdtManager.HP_Proc(TradeContext.BATCHNO)
        ...
        return AbdtManager.ExitThisFlow( '9999', '批量作业处理异常')
