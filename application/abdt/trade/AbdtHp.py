...
def MainHP_Proc( ):
    ...
    try:
        ...
        sql = "SELECT * FROM ABDT_BATCHINFO WHERE STATUS IN ('32')"
        ...
        while ( i  < len(records) ):
            ...
            AbdtManager.WrtLog('回盘:APPNO=[' + TradeContext.APPNO + '],BATCHNO=[' + TradeContext.BATCHNO + ']')
        ...
        return AbdtManager.ExitThisFlow( '9999', '回盘批次信息(回盘)异常')
