...
def MainTJ_Proc( ):
    ...
    #TradeContext.WorkDate='20110704'
    ...
    try:
        ...
        sql = "SELECT * FROM ABDT_BATCHINFO WHERE STATUS IN ('21')"
        ...
        return AbdtManager.ExitThisFlow( '9000', '提交批次信息(申请)异常')
